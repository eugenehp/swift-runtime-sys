...
pub fn show_window(helper_path: &str, title: &str, width: f32, height: f32, build: impl FnOnce(&crate::SwiftUI) -> crate::ViewHandle) {
    init_app();
    let ui = crate::SwiftUI::load(helper_path)
