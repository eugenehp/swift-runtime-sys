...
fn main() {
    ...
    let tests: [(&str, fn(&RuntimeFactory, &RuntimeContract) -> Result<bool, String>); 8] = [
        ("Decimal NumberFormatter render flag", test_decimal_formatter_render),
        ("Decimal NumberFormatter parse flag", test_decimal_formatter_parse),
        ("Decimal NumberFormatter rounding flag", test_decimal_formatter_rounding),
        ("Decimal NumberFormatter invalid-input flag", test_decimal_formatter_invalid),
        ("Decimal arithmetic probe flags", test_decimal_probe_flags),
        ("Percent NumberFormatter render/parse flags", test_percent_probe_flags),
        ("Scientific NumberFormatter render/parse flags", test_scientific_probe_flags),
...
fn test_percent_probe_flags(
    ...
    let flags = read_i32_flag(factory, "swift_number_formatter_percent_scientific_probe_flags")?;
