...
fn main() {
    ...
    results.push(run_test_make_with_capacity(&factory, &mut total, &mut passed));
    results.push(run_test_make_negative_capacity(&factory, &mut total, &mut passed));
    ...
    results.push(run_test_int32_set_element(&factory, &mut total, &mut passed));
    ...
    results.push(run_test_int32_append_growth(&factory, &mut total, &mut passed));
    ...
    results.push(run_test_opaque_ref_get_set(&factory, &mut total, &mut passed));
    results.push(run_test_opaque_ref_append(&factory, &mut total, &mut passed));
    results.push(run_test_opaque_ref_nil_handling(&factory, &mut total, &mut passed));
    results.push(run_test_opaque_ref_bounds(&factory, &mut total, &mut passed));
    results.push(run_test_opaque_ref_release(&factory, &mut total, &mut passed));
...
fn run_test_make_empty_int32(
    ...
    *total += 1;
    let ptr = unsafe {
        let make_fn: extern "C" fn(i32) -> *mut std::ffi::c_void =
            std::mem::transmute(factory.symbol_address("swift_contract_array_int32_make").unwrap());
        make_fn(0)
    };
...
fn run_test_make_with_capacity(
    ...
    *total += 1;
    ...
    if !ptr.is_null() {
        let len = unsafe {
            let len_fn: extern "C" fn(*mut std::ffi::c_void) -> i32 =
                std::mem::transmute(factory.symbol_address("swift_contract_array_int32_len").unwrap());
            len_fn(ptr)
        };
        
        unsafe {
            let release_fn: extern "C" fn(*mut std::ffi::c_void) -> () =
                std::mem::transmute(factory.symbol_address("swift_contract_array_int32_release").unwrap());
            release_fn(ptr);
        }
...
fn run_test_int32_get_bounds(
    ...
    *total += 1;
    ...
    let val_neg = unsafe {
        let get_fn: extern "C" fn(*mut std::ffi::c_void, i32) -> i32 =
            std::mem::transmute(factory.symbol_address("swift_contract_array_int32_get").unwrap());
        get_fn(ptr, -1)
    };
    ...
    if val_neg == 0 && val_oob == 0 {
        *passed += 1;
        ...
        TestResult {
            name: "array_int32_get_bounds",
            passed: false,
            details: Some(format!("Out-of-bounds get should return 0, got {} and {}", val_neg, val_oob)),
        }
    }
}
...
fn run_test_int32_set_element(
    ...
    *total += 1;
    ...
    let result = unsafe {
        let set_fn: extern "C" fn(*mut std::ffi::c_void, i32, i32) -> i32 =
            std::mem::transmute(factory.symbol_address("swift_contract_array_int32_set").unwrap());
        set_fn(ptr, 1, 42)
    };
    ...
    if result == 0 && val == 42 {
        *passed += 1;
        ...
        TestResult {
            name: "array_int32_set_element",
            passed: false,
            details: Some(format!("Set failed or value mismatch: result={}, val={}", result, val)),
        }
    }
}
    ...
    if result_neg == -1 && result_oob == -1 {
        *passed += 1;
        ...
        TestResult {
            name: "array_int32_set_bounds",
            passed: false,
            details: Some(format!("Out-of-bounds set should return -1, got {} and {}", result_neg, result_oob)),
        }
    }
}
...
fn run_test_int32_append(
    ...
    *total += 1;
    ...
    let len1 = unsafe {
        let append_fn: extern "C" fn(*mut std::ffi::c_void, i32) -> i32 =
            std::mem::transmute(factory.symbol_address("swift_contract_array_int32_append").unwrap());
        append_fn(ptr, 10)
    };
    ...
    if last_len == 20 {
        *passed += 1;
        ...
        TestResult {
            name: "array_int32_append_growth",
            passed: false,
            details: Some(format!("Expected len=20 after 20 appends, got {}", last_len)),
        }
    }
}
...
fn run_test_int32_data_ptr(
    ...
    *total += 1;
    ...
    let data_ptr = unsafe {
        let data_fn: extern "C" fn(*mut std::ffi::c_void) -> *const i32 =
            std::mem::transmute(factory.symbol_address("swift_contract_array_int32_data").unwrap());
        data_fn(ptr)
    };
...
fn run_test_make_opaque_ref(
    ...
    *total += 1;
    let ptr = unsafe {
        let make_fn: extern "C" fn(i32) -> *mut std::ffi::c_void =
            std::mem::transmute(factory.symbol_address("swift_contract_array_opaque_ref_make").unwrap());
        make_fn(5)
    };
    ...
    if !ptr.is_null() {
        unsafe {
            let release_fn: extern "C" fn(*mut std::ffi::c_void) -> () =
                std::mem::transmute(factory.symbol_address("swift_contract_array_opaque_ref_release").unwrap());
            release_fn(ptr);
        }
        *passed += 1;
        TestResult {
...
fn run_test_opaque_ref_len(
    ...
    *total += 1;
    ...
    let len = unsafe {
        let len_fn: extern "C" fn(*mut std::ffi::c_void) -> i32 =
            std::mem::transmute(factory.symbol_address("swift_contract_array_opaque_ref_len").unwrap());
        len_fn(ptr)
    };
    ...
    *total += 1;
    ...
    let result = unsafe {
        let set_fn: extern "C" fn(*mut std::ffi::c_void, i32, *mut std::ffi::c_void) -> i32 =
            std::mem::transmute(factory.symbol_address("swift_contract_array_opaque_ref_set").unwrap());
        set_fn(ptr, 1, test_ptr)
    };
    
    let val = unsafe {
        let get_fn: extern "C" fn(*mut std::ffi::c_void, i32) -> *mut std::ffi::c_void =
            std::mem::transmute(factory.symbol_address("swift_contract_array_opaque_ref_get").unwrap());
        get_fn(ptr, 1)
    };
    ...
    if result == 0 && val == test_ptr {
        *passed += 1;
        ...
        TestResult {
            name: "array_opaque_ref_get_set",
            passed: false,
            details: Some(format!("Set/get mismatch: result={}, match={}", result, val == test_ptr)),
        }
    }
}
    ...
    *total += 1;
    ...
    let len1 = unsafe {
        let append_fn: extern "C" fn(*mut std::ffi::c_void, *mut std::ffi::c_void) -> i32 =
            std::mem::transmute(factory.symbol_address("swift_contract_array_opaque_ref_append").unwrap());
    ...
    if len1 == 1 && val.is_null() {
        *passed += 1;
        ...
        TestResult {
            name: "array_opaque_ref_nil_handling",
            passed: false,
            details: Some(format!("Nil handling failed: len={}, is_null={}", len1, val.is_null())),
        }
    }
}
...
fn run_test_mixed_operations(
    ...
    *total += 1;
    ...
    unsafe {
        ...
        release_fn(arr_ptr);
        for int_ptr in int_ptrs {
            let int_release: extern "C" fn(*mut std::ffi::c_void) -> () =
                std::mem::transmute(factory.symbol_address("swift_contract_array_int32_release").unwrap());
            int_release(int_ptr);
        }
    }
    ...
    if len == 3 {
        *passed += 1;
        ...
        TestResult {
            name: "array_mixed_operations",
            passed: false,
            details: Some(format!("Mixed operations failed: expected len=3, got {}", len)),
        }
    }
}
