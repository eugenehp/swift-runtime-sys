...
fn main() {
    ...
    // Test Dictionary<Int32, Int32>
    {
        ...
        let dict_empty: i64 = unsafe {
            let make_fn: extern "C" fn(i32) -> i64 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_i32_make").unwrap());
            make_fn(10)
        };
        println!("dict created: {}", dict_empty);

        let len_empty: i32 = unsafe {
            let len_fn: extern "C" fn(i64) -> i32 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_i32_len").unwrap());
            len_fn(dict_empty)
        };
        ...
        let set_rt1: i32 = unsafe {
            let set_fn: extern "C" fn(i64, i32, i32) -> i32 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_i32_set").unwrap());
        ...
        let get_result1: i32 = unsafe {
            let get_fn: extern "C" fn(i64, i32, *mut i32) -> i32 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_i32_get").unwrap());
        ...
        println!("  get key=99 (missing): found={} val={}", get_result_missing == 1, out_missing);

        // Test 5: Containment checks
        let has_1: i32 = unsafe {
            let contains_fn: extern "C" fn(i64, i32) -> i32 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_i32_contains").unwrap());
        ...
        println!("  get updated key=1: found={} val={}", get_result_updated == 1, out_updated);
    ...
    {
        println!(
            "── Dictionary<Int32, OpaqueRef> (objects as values) ──────────────"
        );

        // Create dictionary
        let dict_ref: i64 = unsafe {
            let make_fn: extern "C" fn(i32) -> i64 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_ref_make").unwrap());
            make_fn(5)
        };
        ...
        let str_apple = unsafe {
            let string_make: extern "C" fn(*const u8, i32) -> i64 =
                std::mem::transmute(factory.symbol_address("swift_contract_construct_string").unwrap());
        ...
        let set_rt1: i32 = unsafe {
            let set_fn: extern "C" fn(i64, i32, i64) -> i32 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_ref_set").unwrap());
        ...
        let len: i32 = unsafe {
            let len_fn: extern "C" fn(i64) -> i32 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_ref_len").unwrap());
            len_fn(dict_ref)
        };
        println!("  len: {}", len);
        ...
        let get_result_apple: i32 = unsafe {
            let get_fn: extern "C" fn(i64, i32, *mut i64) -> i32 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_ref_get").unwrap());
        ...
        let has_10: i32 = unsafe {
            let contains_fn: extern "C" fn(i64, i32) -> i32 =
                std::mem::transmute(factory.symbol_address("swift_contract_dict_ref_contains").unwrap());
