...
// Render a SwiftUI view to PNG using ImageRenderer (macOS 13+)
@MainActor func renderViewToPNG<V: View>(_ view: V, width: CGFloat, height: CGFloat) -> Data? {
...
// ── Ground truth renderers ──

@_cdecl("snapshot_text")
@MainActor public func snapshotText(
...
@_cdecl("snapshot_styled_text")
@MainActor public func snapshotStyledText(
    _ utf8: UnsafePointer<UInt8>, _ len: Int,
...
@_cdecl("snapshot_vstack_texts")
@MainActor public func snapshotVStackTexts(
...
@_cdecl("snapshot_view_handle")
@MainActor public func snapshotViewHandle(
